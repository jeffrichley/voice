"""madrigal.Spec — request object passed to ``madrigal.generate()``.
...
class Spec:
    """One request to ``madrigal.generate()``.
    ...
    def __hash__(self) -> int:
        ...
        # NOTE: cache key derivation (madrigal/_cache_key.py) uses ONLY the
